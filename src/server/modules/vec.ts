...
export class Vector implements Quaternion {
    constructor(public x: number, public y: number, public z: number = null, public w: number = null) {}
    public toString = () : string => {
        return `Vector(${this.x.toFixed(2).toString()}, ${this.y.toFixed(2).toString()}${this.z ? `, ${this.z.toFixed(2).toString()}` : ''}${this.w ? `, ${this.w.toFixed(2).toString()}` : ''})`
    }
